    ...
    module Services
      class OrderBook < Cryptoexchange::Services::Market
        ...
        def order_book_url(market_pair)
          "#{Cryptoexchange::Exchanges::Coinbig::Market::API_URL}/depth?symbol=#{market_pair.base.downcase}_#{market_pair.target.downcase}&size=100"
        end
        ...
        def adapt(output, market_pair)
          ...
          order_book.market    = Coinbig::Market::NAME
