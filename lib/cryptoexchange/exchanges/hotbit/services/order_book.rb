    ...
    module Services
      class OrderBook < Cryptoexchange::Services::Market
        ...
        def order_book_url(market_pair)
          "#{Cryptoexchange::Exchanges::Hotbit::Market::API_URL}/order.depth?market=#{market_pair.base}/#{market_pair.target}&limit=100&interval=0"
        end
        ...
        def adapt(output, market_pair)
          ...
          order_book.market    = Hotbit::Market::NAME
