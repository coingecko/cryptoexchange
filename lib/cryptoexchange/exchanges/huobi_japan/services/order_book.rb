    ...
    module Services
      class OrderBook < Cryptoexchange::Services::Market
        ...
        def order_book_url(market_pair)
          "#{Cryptoexchange::Exchanges::HuobiJapan::Market::API_URL}/market/depth?symbol=#{market_pair.base.downcase}#{market_pair.target.downcase}&type=step0"
        end
        ...
        def adapt(output, market_pair)
          ...
          order_book.market    = HuobiJapan::Market::NAME
