    ...
    module Services
      class OrderBook < Cryptoexchange::Services::Market
        ...
        def order_book_url(market_pair)
          "https://www.bitforex.com/api/v1/market/depth?symbol=coin-#{market_pair.target.downcase}-#{market_pair.base.downcase}&size=200"
        end
        ...
        def adapt(output, market_pair)
          ...
          order_book.market    = Bitforex::Market::NAME
