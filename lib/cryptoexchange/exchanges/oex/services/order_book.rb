    ...
    module Services
      class OrderBook < Cryptoexchange::Services::Market
        ...
        def order_book_url(market_pair)
          "#{Cryptoexchange::Exchanges::Oex::Market::API_URL}/market_dept?symbol=#{market_pair.base.downcase}#{market_pair.target.downcase}&type=step1"
        end
        ...
        def adapt(output, market_pair)
          ...
          order_book.market    = Oex::Market::NAME
