    ...
    module Services
      class OrderBook < Cryptoexchange::Services::Market
        ...
        def ticker_url(market_pair)
          "#{Cryptoexchange::Exchanges::Maplechange::Market::API_URL}/order_book.json?market=#{market_pair.base.downcase}#{market_pair.target.downcase}"
        end
        ...
        def adapt(output, market_pair)
          ...
          order_book.market    = Maplechange::Market::NAME
