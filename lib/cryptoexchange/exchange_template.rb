module Cryptoexchange
  class ExchangeTemplate
    ...
    private
      ...
      def render_template
        @market = <<~'EOF' % {class_name: @class_name, identifier: @identifier}
        ...
        @pairs = <<~'EOF' % {class_name: @class_name}
                    module Cryptoexchange::Exchanges
                      module %{class_name}
                        module Services
        ...
        @tickers = <<~'EOF' % {class_name: @class_name}
                      module Cryptoexchange::Exchanges
                        module %{class_name}
                          module Services
        ...
        @order_book = <<~'EOF' % {class_name: @class_name}
                        module Cryptoexchange::Exchanges
                          module %{class_name}
                            module Services
        ...
        @trades = <<~'EOF' % {class_name: @class_name}
                    module Cryptoexchange::Exchanges
                      module %{class_name}
                        module Services
        ...
        @market_spec = <<~'EOF' % {class_name: @class_name, identifier: @identifier}
                          require 'spec_helper'
        ...
        @integration_spec = <<~'EOF' % {class_name: @class_name, identifier: @identifier}
                            require 'spec_helper'
