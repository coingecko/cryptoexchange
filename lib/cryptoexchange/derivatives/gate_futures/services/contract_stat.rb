    ...
    module Services
      class ContractStat < Cryptoexchange::Services::Market
        ...
        def adapt(open_interest, index, market_pair)
          ...
          contract_stat.funding_rate = index['funding_rate'].to_f if index['funding_rate']
          contract_stat.funding_rate_timestamp = index['funding_next_apply'] if index['funding_next_apply']
          contract_stat.next_funding_rate_predicted = index['funding_rate_indicative'] if index['funding_rate_indicative']
