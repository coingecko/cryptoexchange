...
RSpec.describe 'Cfinex integration specs' do
  let(:client) { Cryptoexchange::Client.new }
  let(:ltc_btc_pair) { Cryptoexchange::Models::MarketPair.new(base: 'LTC', target: 'BTC', market: 'cfinex') }

  it 'fetch pairs' do
    pairs = client.pairs('cfinex')
  ...
  it 'fetch ticker' do
    ...
    expect(ticker.market).to eq 'cfinex'
  ...
  it 'fetch order book' do
    ...
    expect(order_book.market).to eq 'cfinex'
  ...
  it 'fetch trade' do
    ...
    expect(trade.market).to eq 'cfinex'
