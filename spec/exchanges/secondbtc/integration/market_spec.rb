...
RSpec.describe 'Secondbtc integration specs' do
  ...
  let(:btc_usdt_pair) { Cryptoexchange::Models::MarketPair.new(base: 'BTC', target: 'USDT', market: 'secondbtc') }
  ...
  it 'give trade url' do
    trade_page_url = client.trade_page_url 'secondbtc', base: btc_usdt_pair.base, target: btc_usdt_pair.target
    expect(trade_page_url).to eq "https://secondbtc.com/exchange/USDT-BTC"
  end
  ...
  it 'fetch order book' do
    ...
    expect(order_book.market).to eq 'secondbtc'
