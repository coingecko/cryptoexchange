...
RSpec.describe 'Alterdice integration specs' do
  ...
  let(:btc_usd_pair) { Cryptoexchange::Models::MarketPair.new(base: 'btc', target: 'usd', market: 'Alterdice') }
  ...
  it 'fetch order book' do
    ...
    expect(order_book.market).to eq 'Alterdice'
  ...
  it 'fetch trade' do
    ...
    expect(trade.market).to eq 'Alterdice'
