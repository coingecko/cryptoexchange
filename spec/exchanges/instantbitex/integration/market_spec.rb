...
RSpec.describe 'Instant Bitex integration specs' do
  ...
  it 'fetch pairs' do
    pairs = client.pairs('instantbitex')
    expect(pairs).not_to be_empty

    pair = pairs.first
    expect(pair.base).to_not be nil
    expect(pair.target).to_not be nil
    expect(pair.market).to eq 'instantbitex'
  end
  ...
  it 'fetch ticker' do
    ...
    expect(ticker.market).to eq 'instantbitex'
  ...
  it 'fetch order book' do
    ...
    expect(order_book.market).to eq 'instantbitex'
  ...
  it 'fetch trade' do
    ...
    expect(trade.market).to eq 'instantbitex'
