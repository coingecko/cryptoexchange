...
RSpec.describe 'Bitalong integration specs' do
  let(:client) { Cryptoexchange::Client.new }
  let(:btc_usdt_pair) { Cryptoexchange::Models::MarketPair.new(base: 'BTC', target: 'USDT', market: 'bitalong') }
  ...
  it 'has trade_page_url' do
    ...
    expect(trade_page_url).to eq "https://www.bitalong.com/trade/index/market/btc_usdt"
  end

  it 'fetch pairs' do
    pairs = client.pairs('bitalong')
    expect(pairs).not_to be_empty

    pair = pairs.first
    expect(pair.base).to_not be nil
    expect(pair.target).to_not be nil
    expect(pair.market).to eq 'bitalong'
  end
  ...
  it 'fetch ticker' do
    ...
    expect(ticker.market).to eq 'bitalong'
  ...
  it 'fetch order book' do
    ...
    expect(order_book.market).to eq 'bitalong'
  ...
  it 'fetch trade' do
    ...
    expect(trade.market).to eq 'bitalong'
