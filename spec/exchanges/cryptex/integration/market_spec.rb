...
RSpec.describe 'Cryptex integration specs' do
  let(:client) { Cryptoexchange::Client.new }
  let(:btc_usd_pair) { Cryptoexchange::Models::MarketPair.new(base: 'BTC', target: 'USD', market: 'cryptex') }

  it 'fetch pairs' do
    pairs = client.pairs('cryptex')
  ...
  it 'fetch ticker' do
    ...
    expect(ticker.market).to eq 'cryptex'
  ...
  it 'fetch order book' do
    ...
    expect(order_book.market).to eq 'cryptex'
  ...
  it 'fetch trade' do
    ...
    expect(trade.market).to eq 'cryptex'
