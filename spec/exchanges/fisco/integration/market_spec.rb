...
RSpec.describe 'Fisco integration specs' do
  let(:client) { Cryptoexchange::Client.new }
  let(:btc_jpy_pair) { Cryptoexchange::Models::MarketPair.new(base: 'BTC', target: 'JPY', market: 'fisco') }

  it 'fetch pairs' do
    pairs = client.pairs('fisco')
  ...
  it 'fetch ticker' do
    ...
    expect(ticker.market).to eq 'fisco'
  ...
  it 'fetch order book' do
    ...
    expect(order_book.market).to eq 'fisco'
  ...
  it 'fetch trade' do
    ...
    expect(trade.market).to eq 'fisco'
