...
RSpec.describe 'Dextrade integration specs' do
  ...
  let(:btc_usd_pair) { Cryptoexchange::Models::MarketPair.new(base: 'btc', target: 'usd', market: 'Dextrade') }
  ...
  it 'fetch order book' do
    ...
    expect(order_book.market).to eq 'Dextrade'
  ...
  it 'fetch trade' do
    ...
    expect(trade.market).to eq 'Dextrade'
