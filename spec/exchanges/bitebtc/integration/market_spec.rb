...
RSpec.describe 'Bitebtc integration specs' do
  let(:client) { Cryptoexchange::Client.new }
  let(:eth_btc_pair) { Cryptoexchange::Models::MarketPair.new(base: 'eth', target: 'btc', market: 'bitebtc') }

  it 'fetch pairs' do
    pairs = client.pairs('bitebtc')
  ...
  it 'fetch ticker' do
    ...
    expect(ticker.market).to eq 'bitebtc'
  ...
  it 'fetch order book' do
    ...
    expect(order_book.market).to eq 'bitebtc'
  ...
  it 'fetch trade' do
    ...
    expect(trade.market).to eq 'bitebtc'
  end
end
