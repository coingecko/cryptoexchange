...
RSpec.describe 'HuobiThailand integration specs' do
  let(:client) { Cryptoexchange::Client.new }
  let(:market) { 'huobi_thailand' }
  let(:pair) { Cryptoexchange::Models::MarketPair.new(base: 'BTC', target: 'THB', market: 'huobi_thailand') }
  ...
  it 'give trade url' do
    ...
    expect(trade_page_url).to eq "https://www.huobi.co.th/th-th/exchange/#s=btc_thb"
  end
