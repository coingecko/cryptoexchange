...
RSpec.describe 'CoinAsset integration specs' do
  ...
  it 'fetch pairs' do
    ...
    expect(pair.market).to eq 'coinasset'
  end
  ...
  it 'fetch ticker' do
    ...
    expect(ticker.market).to eq 'coinasset'
  ...
  it 'fetch order book' do
    ...
    expect(order_book.market).to eq 'coinasset'
  ...
  it 'fetch trade' do
    ...
    expect(trade.market).to eq 'coinasset'
