...
RSpec.describe 'Coinpulse integration specs' do
  let(:client) { Cryptoexchange::Client.new }
  let(:eth_btc_pair) { Cryptoexchange::Models::MarketPair.new(base: 'ETH', target: 'BTC', market: 'coinpulse') }

  it 'fetch pairs' do
    pairs = client.pairs('coinpulse')
  ...
  it 'fetch order book' do
    ...
    expect(order_book.market).to eq 'coinpulse'
  ...
  it 'fetch ticker' do
    ...
    expect(ticker.market).to eq 'coinpulse'
  ...
  it 'fetch trade' do
    ...
    expect(trade.market).to eq 'coinpulse'
