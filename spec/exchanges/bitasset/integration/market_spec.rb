...
RSpec.describe 'Bitasset integration specs' do
  let(:client) { Cryptoexchange::Client.new }
  let(:btc_usdt_pair) { Cryptoexchange::Models::MarketPair.new(base: 'BTC', target: 'USDT', market: 'bitasset') }
  ...
  it 'has trade_page_url' do
    ...
    expect(trade_page_url).to eq "https://www.bitasset.com/ktrade/BTC-USDT"
  end

  it 'fetch pairs' do
    pairs = client.pairs('bitasset')
    expect(pairs).not_to be_empty

    pair = pairs.first
    expect(pair.base).to_not be nil
    expect(pair.target).to_not be nil
    expect(pair.market).to eq 'bitasset'
  end
  ...
  it 'fetch ticker' do
    ...
    expect(ticker.market).to eq 'bitasset'
  ...
  it 'fetch order book' do
    ...
    expect(order_book.market).to eq 'bitasset'
  ...
  it 'fetch trade' do
    ...
    expect(trade.market).to eq 'bitasset'
