...
RSpec.describe 'DarbFinance integration specs' do
  let(:client) { Cryptoexchange::Client.new }
  let(:btc_usd_pair) { Cryptoexchange::Models::MarketPair.new(base: 'BTC', target: 'USD', market: 'darb_finance') }

  it 'fetch pairs' do
    pairs = client.pairs('darb_finance')
  ...
  it 'fetch ticker' do
    ...
    expect(ticker.market).to eq 'darb_finance'
  ...
  it 'fetch order book' do
    ...
    expect(order_book.market).to eq 'darb_finance'
  ...
  it 'fetch trade' do
    ...
    expect(trade.market).to eq 'darb_finance'
