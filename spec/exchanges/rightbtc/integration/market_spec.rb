...
RSpec.describe 'RightBTC integration specs' do
  ...
  it 'fetch ticker' do
    ...
    expect(ticker.market).to eq 'rightbtc'
  ...
  it 'fetch order book' do
    ...
    expect(order_book.market).to eq 'rightbtc'
  ...
  it 'fetch trade' do
    ...
    expect(trade.market).to eq 'rightbtc'
