...
RSpec.describe 'Cryptlocex integration specs' do
  let(:client) { Cryptoexchange::Client.new }
  let(:market) { 'cryptlocex' }
  let(:ltc_usdt_pair) { Cryptoexchange::Models::MarketPair.new(base: 'LTC', target: 'USDT', market: market) }
  ...
  it 'give trade url' do
    ...
    expect(trade_page_url).to eq "https://trade.cryptlocex.com/trade/index/market/ltc_usdt/"
  end
